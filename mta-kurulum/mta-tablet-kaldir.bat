...
title MTA SONDAJ TAKIP - Kiosk Uygulamasini Kaldirma
...
set "OWNER_STATUS=%TEMP%\mta-kiosk-owner-%RANDOM%-%RANDOM%.txt"
...
echo.
echo ============================================================
echo   MTA SONDAJ TAKIP - KIOSK UYGULAMASINI KALDIRMA
echo ============================================================
echo.
...
if not errorlevel 1 (
  ...
  echo   2. Ekran kenarindan iceri kaydirin ^(veya geri tusuna basin,
  echo      ya da sol ust koseye 3 saniyede 5 kez dokunun^).
  echo   3. Ayarlar parolasi 482910 DEGIL, KALDIRMA parolasi 905174 girin.
  ...
  if not errorlevel 1 (
    ...
    echo Ayarlar parolasi degil, KALDIRMA parolasi 905174 kullanilmalidir.
...
if not errorlevel 1 (
  ...
  if not errorlevel 1 (
    ...
    echo Kaldirma parolasi uygulanmadan paket kaldirilamaz.
    type "%OWNER_STATUS%"
  )
  del /Q "%OWNER_STATUS%" 1>nul 2>nul
  pause
...
echo [BASARILI] MTA kiosk uygulamasi tamamen kaldirildi.
